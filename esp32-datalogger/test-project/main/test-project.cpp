...
const gpio_num_t RADIO_CTS_PIN = GPIO_NUM_34;
const gpio_num_t RADIO_RTS_PIN = GPIO_NUM_35;
...
//static const i2c_port_num_t PITOT_I_PORT = I2C_NUM_0;
...
esp_err_t radio_uart_setup(){
	...
	ESP_ERROR_CHECK(uart_set_pin(RADIO_UART_NUM, RADIO_TX_PIN, RADIO_RX_PIN, RADIO_RTS_PIN, RADIO_CTS_PIN, UART_PIN_NO_CHANGE, UART_PIN_NO_CHANGE));
